...
export async function createInvoice(prevState: State, formData: FormData) {
  ...
  //console.log(validatedFields); // (delete this line) Ver cómo se imprime el objeto validatedFields cuando se trata de enviar un form vacío
...
export async function updateInvoice(id: string, prevState: State, formData: FormData) {
  ...
  // throw new Error('Failed to Delete Invoice'); // throwing an error to simulate and see what is happening 
